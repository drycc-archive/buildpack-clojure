...
curl -o $LEIN_FILE --location http://buildpacks.drycc.cc/github.com/technomancy/leiningen/releases/download/$LEIN_VERSION/leiningen-$LEIN_VERSION-standalone.zip
