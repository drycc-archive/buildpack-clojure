...
curl -o $LEIN_FILE --location https://buildpacks.oss-accelerate.aliyuncs.com/github.com/technomancy/leiningen/releases/download/$LEIN_VERSION/leiningen-$LEIN_VERSION-standalone.zip
